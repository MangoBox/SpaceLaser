...
path_output = '/Users/jacobsolsky/Documents/GitHub/SpaceLaser/Horizons/planets.csv'
path_queries = '/Users/jacobsolsky/Documents/GitHub/SpaceLaser/Horizons/Horizons_queries.csv'
...
def: jpl_request(name, jpl_id)
    name = name #INSERT NAME OF OBJECT HERE
    query_link = request_base
    query_link += "&MAKE_EPHEM=YES"
    query_link += "&COMMAND='" + jpl_id + "'" #INSERT JPL ID HERE
